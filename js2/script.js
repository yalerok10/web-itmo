...
function design() // дизайн блока с функциями
{
  document.getElementById('functionForms').style.backgroundColor = 'lightblue';
  ...
  document.getElementById('preferencesFunction').style.backgroundColor = 'lightblue';
  ...
  document.getElementById('deleteRowFunction').style.backgroundColor = 'lightblue';
